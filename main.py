...
def main(page: ft.Page):
    ...
    layout = ft.Column(
        ...
        controls=[
            ...
            ft.Text(value="Marcar suas tarefas como concluido te motiva a continuar focado", size=16, color=ft.colors.WHITE),
            ...
            ft.TextField(hint_text="Escreva um hábito...", border=ft.InputBorder.UNDERLINE, border_color=ft.colors.WHITE, bgcolor=ft.colors.GREY_50, on_submit=add_habit)
